...
final class RenderConfig
{
	...
	**/
	 ...
	 * @since 1.0.0
	**/
	public var desynchronized:Bool = false;
	 ...
	 * @since 1.0.0
	**/
	public var pixelArt:Bool = false;
	...
	**/
	 ...
	 * @since 1.0.0
	**/
	public var powerPreference:PowerPreference = DEFAULT;
