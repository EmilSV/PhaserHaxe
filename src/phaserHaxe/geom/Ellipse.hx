 ...
 *
**/
@:using(phaserHaxe.geom.EllipseTools)
class Ellipse
{
	/**
	...
	**/
	...
	// {
	// 	return EllipseTools.contains(this, x, y);
	// }
	...
	// {
	// 	return EllipseTools.GetPoint(this, position, out);
	// }
	...
	// {
	// 	return EllipseTools.getPointAny(this, position, out);
	// }
	...
	// {
	// 	return EllipseTools.getPoints(this, quantity, stepRate, output);
	// }
	...
	// {
	// 	return EllipseTools.random(this, point);
	// }
	...
	// {
	// 	return EllipseTools.randomAny(this, point);
	// }
